describe('subject', function () {
    ...
    it('ไม่ได้ใส่หน่วยกิต', function () {
        ...
        cy.get('#modalInsert > .modal-dialog > .modal-content > .modal-body > form.ng-untouched > :nth-child(1) > :nth-child(1) > .form-group > .form-control').click()
        cy.get('#modalInsert > .modal-dialog > .modal-content > .modal-body > form.ng-untouched > :nth-child(1) > :nth-child(1) > .form-group > .form-control').type('88621359')
        ...
        cy.get('#modalInsert > .modal-dialog > .modal-content > .modal-body > .ng-invalid.ng-touched > :nth-child(2) > :nth-child(1) > .form-group > .form-control').click()
        cy.get('#modalInsert > .modal-dialog > .modal-content > .modal-body > .ng-invalid.ng-touched > :nth-child(2) > :nth-child(1) > .form-group > .form-control').type('วิทยาการสารสนเทศ')
