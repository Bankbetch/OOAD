describe('subject', function() {
    ...
    it('ไม่กรอกรหัสวิชา', function() {
       ...
       cy.get('#modalInsert > .modal-dialog > .modal-content > .modal-body > form.ng-untouched > :nth-child(1) > :nth-child(2) > .form-group > .form-control').click()
       cy.get('#modalInsert > .modal-dialog > .modal-content > .modal-body > form.ng-untouched > :nth-child(1) > :nth-child(2) > .form-group > .form-control').type('web progarmming')
       cy.get('#modalInsert > .modal-dialog > .modal-content > .modal-body > form.ng-touched > :nth-child(2) > :nth-child(1) > .form-group > .form-control').click()
       cy.get('#modalInsert > .modal-dialog > .modal-content > .modal-body > form.ng-touched > :nth-child(2) > :nth-child(1) > .form-group > .form-control').type('วิทยาการสารสนเทศ')
