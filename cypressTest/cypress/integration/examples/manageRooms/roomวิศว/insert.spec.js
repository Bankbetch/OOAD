describe('manageRooms', () => {
    ...
    it('clickManageRooms', () => {
     ...
     it('insert', () => {
        cy.get('#exampleModal > .modal-dialog > .modal-content > .modal-body > form.ng-untouched > :nth-child(1) > .form-control').select('วิศวกรรมศาสตร์')
        cy.get('#exampleModal > .modal-dialog > .modal-content > .modal-body > .ng-invalid.ng-dirty > :nth-child(2) > :nth-child(1) > .form-group > .form-control').type('3a')
