        ...
        newBlob.save(function(err, data) {
            chai.request(server)
                ...
                .end(function(err, res) {
                    ...
                    res.body.types[0].should.equal('นิสิต');
                    res.body.types[1].should.equal('คนคุมสอบ');
    ...
    it('should add a SINGLE blob on /blobs POST add', function(done) {
        chai.request(server)
            ...
            .end(function(err, res) {
                ...
                res.body.SUCCESS.types[0].should.equal('นิสิต');
